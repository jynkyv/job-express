...
import { ClipboardList, LayoutDashboard, ScanFace } from "lucide-react";
...
const DashboardLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  if (standalonePaths.has(normalizedPathname)) {
    return <div className="h-screen overflow-hidden bg-[#2f73c8]">{children}</div>;
  }
      ...
      <SidebarProvider open={open} onOpenChange={setOpen}>
        ...
        >
          <SidebarHeader className="h-16 flex items-center justify-center border-b border-border/40">
            <div className="w-full cursor-pointer justify-center flex items-center" onClick={() => router.push("/")}
            >
              <Logo
